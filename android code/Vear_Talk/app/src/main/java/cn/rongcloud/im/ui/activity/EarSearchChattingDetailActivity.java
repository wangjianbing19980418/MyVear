...
public class EarSearchChattingDetailActivity extends Activity {
    ...
    private void initData() {
        ...
        mPressBackImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                EarSearchChattingDetailActivity.this.finish();
            }
        });
        ...
        mChattingRecordsListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (object instanceof Message) {
                    ...
                    RongIM.getInstance().startConversation(EarSearchChattingDetailActivity.this, conversation.getConversationType(), conversation.getTargetId(), mResult.getTitle());
                }
            }
        });
        //分页加载,每页加载50条记录;
