...
public class PrivateChatDetailActivity extends BaseActivity implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        deleteFriend = (Button) findViewById(R.id.deleteFriend_btn);
        ...
        if (!TextUtils.isEmpty(fromConversationId)) {
            ...
            updateUI();
            mFriend = SealUserInfoManager.getInstance().getFriendByID(mUserInfo.getUserId());
        }
    ...
    public Object doInBackground(int requestCode, String id) throws HttpException {
        if (requestCode == DELETE_FRIEND) {
            Toast.makeText(mContext, "删除成功", Toast.LENGTH_SHORT).show();
            return action.deleteFriend(mFriend.getUserId());
        }
...
//                    SealUserInfoManager.getInstance().deleteBlackList();
    ...
    private void initView() {
        ...
        deleteFriend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new AlertDialog.Builder(PrivateChatDetailActivity.this)
                        .setTitle("提示")
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.ac_ll_search_messages:
                Intent searchIntent = new Intent(PrivateChatDetailActivity.this, EarSearchChattingDetailActivity.class);
