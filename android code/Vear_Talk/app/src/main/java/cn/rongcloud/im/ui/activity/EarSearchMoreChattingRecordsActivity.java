...
public class EarSearchMoreChattingRecordsActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ear_search_more_info);
    ...
    private void initData() {
        ...
        mPressBackImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                EarSearchMoreChattingRecordsActivity.this.finish();
            }
        });
        ...
        mChattingRecordsListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (selectObj instanceof SealSearchConversationResult) {
                    ...
                    if (count == 1) {
                        RongIM.getInstance().startConversation(EarSearchMoreChattingRecordsActivity.this, conversation.getConversationType(), conversation.getTargetId(), result.getTitle());
                    } else {
                        Intent intent = new Intent(EarSearchMoreChattingRecordsActivity.this, EarSearchChattingDetailActivity.class);
