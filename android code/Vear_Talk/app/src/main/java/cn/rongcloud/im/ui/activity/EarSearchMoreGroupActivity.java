 ...
 */
public class EarSearchMoreGroupActivity extends Activity {
    ...
    public void initView() {
                    ...
                    protected void onPostExecute(SearchResult searchResult) {
                        ...
                        if (searchResult.getFilterStr().equals(mFilterString)) {
                            ...
                            if (filterGroupId.size() > 0) {
                                ...
                                GroupListAdapter groupListAdapter = new GroupListAdapter(EarSearchMoreGroupActivity.this, filterGroupId, filterGroupNameListMap, filterGroupMemberNameListMap, mFilterString);
        ...
        mPressBackImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                EarSearchMoreGroupActivity.this.finish();
            }
        });
        ...
        mGroupsListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (selectObject instanceof String) {
                    ...
                    if (groupInfo != null) {
                        RongIM.getInstance().startGroupChat(EarSearchMoreGroupActivity.this, groupInfo.getGroupsId(), groupInfo.getName());
                    }
                }
            }
        });
